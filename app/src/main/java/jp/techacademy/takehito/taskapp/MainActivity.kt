package jp.techacademy.takehito.taskapp
...
import jp.techacademy.takehito.taskapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    /*
    追加　SearchView(listView検索)を使用するため
     */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        「文字列が変わったとき」と「検索ボタンが押されたとき」のイベントリスナー
         */
